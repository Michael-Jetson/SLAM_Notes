...
解得：
$$
a=\frac{2059.7039*10-298.5494*55}{385*10-55*55}\\
b=\frac{385*298.5494-2059.7039*55}{385*10-55*55}
$$
...
- 我们使用激光雷达的scan-match数据作为真值$u^*_i$，因为我们认为激光雷达的观测值比里程计要准确，这里$u_i$表示第$i$帧和第$j$帧之间的相对位姿关系，这里用$P_i$表示第$i$帧
- 里程计测量得到的数据为$u_i$
